...
class FunctionLevelSimpleTestFloatingPointImplementation : public FloatingPointImplementation {
 public:
...
REGISTER_FLOATING_POINT_IMPL(FunctionLevelSimpleTestFloatingPointImplementation);
